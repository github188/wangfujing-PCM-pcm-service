 ...
 * 分类属性字典表VO
 * <p>
 * 更改字段channelSid为String类型,查询使用in()
 * 
 * @Class Name CategoryPropsDictVO
 * @Author wangsy
 * @Create In 2015年8月31日
 */
public class CategoryPropsDictVO extends PageModel<CategoryPropsDictVO> {
    private Long sid;

 ...
 * @Create In 2015年7月2日
 */
public class PcmAddCategoryDto {
	...
	public String toString() {
		return "PcmAddCategoryDto [sid=" + sid + ", categorySid=" + categorySid + ", parentSid="
				...
				+ ", categoryCode=" + categoryCode + ", actionCode=" + actionCode + ", actionDate="

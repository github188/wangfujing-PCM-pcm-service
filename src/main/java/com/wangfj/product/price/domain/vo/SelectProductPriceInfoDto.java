...
public class SelectProductPriceInfoDto {
	private Long sid;
	...
	public String toString() {
		return "SelectProductPriceInfoDto [sid=" + sid + ", productCode=" + productCode
				...
				+ ", modelCode=" + modelCode + ", articleNum=" + articleNum + ", brandGroupCode="
				+ brandGroupCode + ", brandGroupName=" + brandGroupName + ", unitCode=" + unitCode
				+ ", unitName=" + unitName + "]";
	}

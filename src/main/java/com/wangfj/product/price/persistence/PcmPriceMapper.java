...
public interface PcmPriceMapper {
	 ...
	 */
	List<PcmPrice> queryExpirePriceInfoList(BasePage basePage);
	 ...
	 */
	List<PublishDTO> queryErpProCurrActivePriceInfoList(BasePage basePage);
	 ...
	 * @Create In 2016年03月26日 By kongqf
	 */
	List<SelectProductPriceInfoDto> findProductPriceInfoByPara(
			QueryProductPriceInfoDto queryProductPriceInfoDto);

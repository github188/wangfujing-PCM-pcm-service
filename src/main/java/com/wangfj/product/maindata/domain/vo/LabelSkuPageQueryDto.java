 ...
 * @Create In 2015年7月2日
 */
public class LabelSkuPageQueryDto extends BaseDto {
	private Long sid;
	...
	private String categoryName;// 工业分类
	private String statCategory;// 统计分类
	private String statCategoryName;// 统计分类
	...
	private String industryCondition;// 业态类型(0百货 1超市 2电商)
	...
	public String toString() {
		return "LabelSkuPageQueryDto [sid=" + sid + ", spuSid=" + spuSid + ", skuCode=" + skuCode
				...
				+ ", categoryName=" + categoryName + ", statCategory=" + statCategory
				+ ", statCategoryName=" + statCategoryName + ", spuSale=" + spuSale
				+ ", seasonCode=" + seasonCode + ", season=" + season + ", onMarketDate="
				+ onMarketDate + ", activityFlg=" + activityFlg + ", sexSid=" + sexSid
				+ ", awesome=" + awesome + ", proSellingTime=" + proSellingTime + ", shortDes="
				+ shortDes + ", editFlag=" + editFlag + ", specialDes=" + specialDes
				+ ", colorSid=" + colorSid + ", colorName=" + colorName + ", industryCondition="
				+ industryCondition + ", currentPage=" + currentPage + ", pageSize=" + pageSize
				+ ", start=" + start + ", limit=" + limit + ", isAddTag=" + isAddTag + ", tagSid="
				+ tagSid + "]";
	}

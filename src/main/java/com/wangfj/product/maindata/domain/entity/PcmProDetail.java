 ...
 * @Create In 2015年7月2日
 */
public class PcmProDetail extends BaseEntity {
	private Long sid;
	/**
	 * 商品明细表编码
	 */
	...
	public String toString() {
		return "PcmProDetail [sid=" + sid + ", productDetailSid=" + productDetailSid
				+ ", proDetailName=" + proDetailName + ", productSid=" + productSid
				+ ", proStanSid=" + proStanSid + ", proColorSid=" + proColorSid + ", proColorName="
				+ proColorName + ", proColorAlias=" + proColorAlias + ", proStanName="
				+ proStanName + ", memo=" + memo + ", barcode=" + barcode + ", proWriTime="
				+ proWriTime + ", photoSaleCodeSid=" + photoSaleCodeSid + ", photoStatus="
				+ photoStatus + ", optUserSid=" + optUserSid + ", optRealName=" + optRealName
				+ ", optUpdateTime=" + optUpdateTime + ", planMaker=" + planMaker + ", planTime="
				+ planTime + ", photoPlanSid=" + photoPlanSid + ", proActiveBit=" + proActiveBit
				+ ", proType=" + proType + ", sellingStatus=" + sellingStatus + ", searchKey="
				+ searchKey + ", keyWord=" + keyWord + ", sizePictureUrl=" + sizePictureUrl
				+ ", features=" + features + ", articleNum=" + articleNum + "]";
	}

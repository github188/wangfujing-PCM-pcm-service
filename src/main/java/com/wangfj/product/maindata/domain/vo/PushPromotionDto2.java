...
public class PushPromotionDto2 {
	...
	public String toString() {
		return "PushPromotionDto2 [productCode=" + productCode + ", productName=" + productName
				...
				+ ", shortDes=" + shortDes + ", packDesE=" + Arrays.toString(packDesE)
				+ ", searchKey=" + searchKey + ", keyword=" + keyword + ", specialDes="
				+ specialDes + ", isPublished=" + isPublished + ", sizeImageUrl=" + sizeImageUrl

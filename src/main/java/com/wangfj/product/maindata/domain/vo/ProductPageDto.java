...
public class ProductPageDto extends BaseDto {
	...
	private String contractCode;// 自营要约号
	private String contractErpCode;// 联营大码要约号
	...
	public String getContractErpCode() {
		return contractErpCode;
	}

	public void setContractErpCode(String contractErpCode) {
		this.contractErpCode = contractErpCode;
	}
	...
	public String toString() {
		return "ProductPageDto{" +
				...
				", manageCategoryCode='" + manageCategoryCode + '\'' +
				", colorCode='" + colorCode + '\'' +
				", colorName='" + colorName + '\'' +
				", colorSid='" + colorSid + '\'' +
				", proColor='" + proColor + '\'' +
				...
				", statCategoryCode='" + statCategoryCode + '\'' +
				", statCategoryName='" + statCategoryName + '\'' +
				", channelSid='" + channelSid + '\'' +
				", channelName='" + channelName + '\'' +
				", productType='" + productType + '\'' +
				", tmsParam='" + tmsParam + '\'' +
				", promotionPrice='" + promotionPrice + '\'' +
				", supplierIntBarCode=" + supplierIntBarCode +
				...
				", contractErpCode='" + contractErpCode + '\'' +
				", procurementUserCode='" + procurementUserCode + '\'' +
				", inputUserCode='" + inputUserCode + '\'' +
				", glCategoryName='" + glCategoryName + '\'' +
				", billsNo='" + billsNo + '\'' +

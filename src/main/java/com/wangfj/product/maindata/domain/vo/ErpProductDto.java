...
public class ErpProductDto {
	...
	public String toString() {
		return "ErpProductDto [sid=" + sid + ", storeCode=" + storeCode + ", shopName=" + shopName
				...
				+ brandCode + ", groupBrandCode=" + groupBrandCode + ", optUserSid=" + optUserSid
				+ ", productName=" + productName + ", productType=" + productType
				+ ", productCategory=" + productCategory + ", stanName=" + stanName
				...
				+ ", commissionRate=" + commissionRate + ", productAbbr=" + productAbbr

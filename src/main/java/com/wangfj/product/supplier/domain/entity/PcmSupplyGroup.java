...
public class PcmSupplyGroup {
    ...
    private String bizCertificateNo;
    ...
    private String legalPersonIcCode;

    private String legalPersonContact;

    private String agent;

    private String agentIcCode;
    ...
    private String contactIcCode;

    private String contactWay;

    private String businessScope;

    private Integer keySupplier;
    ...
    private Integer returnSupply;

    private String joinSite;

    private Integer dropship;

    private String erpSupplierCode;

    private String zlyFlag;

    private String zzxxhcFlag;

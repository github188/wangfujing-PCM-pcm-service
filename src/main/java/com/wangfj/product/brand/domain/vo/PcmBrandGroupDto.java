...
/**
 * 
 * @Class Name PcmBrandGroupDto
 * @Author wangx
 * @Create In 2015年7月30日
 */
public class PcmBrandGroupDto extends BaseDto {
	...
	private Date brandCreateTimes;// 创建时间
	...
	public Date getBrandCreateTimes() {
		return brandCreateTimes;
	}

	public void setBrandCreateTimes(Date brandCreateTimes) {
		this.brandCreateTimes = brandCreateTimes;
	}
	...
	public String toString() {
		return "PcmBrandGroupDto [sid=" + sid + ", brandSid=" + brandSid + ", brandName="
				+ brandName + ", brandNameSpell=" + brandNameSpell + ", brandNameAlias="
				+ brandNameAlias + ", brandNameEn=" + brandNameEn + ", brandDesc=" + brandDesc
				+ ", brandPict=" + brandPict + ", brandCreateTimes=" + brandCreateTimes
				+ ", brandCreateCountry=" + brandCreateCountry + ", brandSpecialty="
				+ brandSpecialty + ", brandSuitability=" + brandSuitability + ", isFactoryStore="
				+ isFactoryStore + ", factoryBigPic=" + factoryBigPic + ", factorySmallPic="
				+ factorySmallPic + ", activityBigPic=" + activityBigPic + ", activitySmallPic="
				+ activitySmallPic + ", factoryStoreOrder=" + factoryStoreOrder
				+ ", parentFactoryStoreId=" + parentFactoryStoreId + ", logoPic=" + logoPic
				+ ", awesome=" + awesome + ", isDisplay=" + isDisplay + ", status=" + status + "]";
	}

...
/**
 * 
 * @Class Name PcmOrganizationDto
 * @Author yedong
 * @Create In 2015年7月3日
 */
public class PcmOrganizationDto extends BaseDto {
	private Long sid;
	...
	public String toString() {
		return "PcmOrganizationDto [sid=" + sid + ", parentSid=" + parentSid
				...
				+ ", areaCode=" + areaCode + ", start=" + start + ", limit=" + limit + ", count="
				+ count + "]";
	}

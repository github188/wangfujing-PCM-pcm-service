...
public class SelectProductStockInfoDto {
	private Long sid;
	...
	public String toString() {
		return "SelectProductStockInfoDto [sid=" + sid + ", productCode=" + productCode
				+ ", erpProductCode=" + erpProductCode + ", skuCode=" + skuCode + ", productName="
				+ productName + ", productType=" + productType + ", supplierCode=" + supplierCode
				+ ", supplierName=" + supplierName + ", counterCode=" + counterCode
				+ ", counterName=" + counterName + ", storeCode=" + storeCode + ", storeName="
				+ storeName + ", channelSid=" + channelSid + ", channelName=" + channelName
				+ ", salesPrice=" + salesPrice + ", marketPrice=" + marketPrice + ", priceType="
				+ priceType + ", stockType=" + stockType + ", stockMode=" + stockMode
				+ ", negativeStock=" + negativeStock + ", isSale=" + isSale + ", saleStock="
				+ saleStock + ", edefectiveStock=" + edefectiveStock + ", returnStock="
				+ returnStock + ", lockedStock=" + lockedStock + ", colorCode=" + colorCode
				+ ", colorName=" + colorName + ", stanCode=" + stanCode + ", stanName=" + stanName
				+ ", modelCode=" + modelCode + ", articleNum=" + articleNum + ", brandCode="
				+ brandCode + ", brandName=" + brandName + ", brandGroupCode=" + brandGroupCode
				+ ", brandGroupName=" + brandGroupName + ", unitCode=" + unitCode + ", unitName="
				+ unitName + "]";
	}
